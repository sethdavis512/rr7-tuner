...
import { fileExists, updateRoutesFile } from '../utils/file-operations.mjs';
...
async function createBetterAuthComponents() {
    ...
    // Step 4: Register routes in routes.ts if it exists
    printStep('Registering authentication routes in routes.ts');
    ...
    printSuccess('Authentication routes registered successfully');
}
